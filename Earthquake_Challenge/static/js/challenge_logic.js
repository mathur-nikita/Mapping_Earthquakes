...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  d3.json(tectonicData).then(function(data) {
    ...
    /// style for tectonic plates layer
    function tectonicStyleInfo(feature) {
      return {
        color: "#0000FF",
        weight: 4
      };
    ...
    L.geoJson(data, {
      style: tectonicStyleInfo
    }).addTo(tectonicPlates);

  // Add the tectonicPlates layer to our map.
  tectonicPlates.addTo(map);

  });// end of tectonicData section


  // 3. Retrieve the major earthquake GeoJSON data >4.5 mag for the week.
  let majorEarthquakesData = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson";
  ...
  });//end of majorEarthquakes section
